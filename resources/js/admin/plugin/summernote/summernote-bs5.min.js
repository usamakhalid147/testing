  ...
  Table_createClass(Table, [{
    ...
    */
    ...
    value: function createTable(colCount, rowCount, options) {
      ...
      var $responsiveDiv = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div class="table-responsive"></div>');
      $responsiveDiv[0].appendChild($table[0]);

      return $responsiveDiv[0];
    }
    /**
