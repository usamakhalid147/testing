...
<script type="text/javascript">
	routeList['update_hotel'] = {!! json_encode(route('host.hotels.update',['id' => $hotel->id])); !!};
	routeList['update_photo_order'] = {!! json_encode(route('host.hotels.update_photo_order',['id' => $hotel->id])); !!};
