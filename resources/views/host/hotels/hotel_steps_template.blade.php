...
<div class="content-section">
	<div class="row">
		<div class="form-group col-md-12" :class="{'required-input': hotel.name == ''}">
			...
			{!! Form::text('name',null,['id' => 'name','class'=>'form-control','v-model' => 'hotel.name','placeholder' => Lang::get('messages.hotel_name')]) !!}
...
<div class="content-section">
	...
	<div class="row mt-2">
		...
		<div class="form-group col-md-6">
			<label for="state"> @lang('messages.town') </label>
			...
			<li v-for="(image,index) in hotel.hotel_photos" class="image-wrapper col-md-3 col-lg-4" id="@{{ 'hotel_photo_'+image.id }}">
				...
				<div class="card">
					...
					<div class="card-body d-none">
						<p class="card-text">
							<textarea name="photos_description" :id="'photos_description-'+image.id" class="form-control" rows="2" v-model="hotel.hotel_photos.description"></textarea>
						</p>
					</div>
				</div>
			</li>
...
<div class="content-section">
	...
	<div class="form-group row">
		<label for="cancellation_policy" class="col-sm-3 col-form-label"> @lang('messages.notice_days') </label>
		<div class="col-sm-9">
	...
	--}}
	<div class="form-group row">
		<label for="cancellation_policy" class="col-sm-3 col-form-label"> @lang('messages.min_los') <em class="text-danger"> *</em></label>
	...
	<div class="form-group row">
		<label for="cancellation_policy" class="col-sm-3 col-form-label"> @lang('messages.max_los') </label>
		<div class="col-sm-9">
...
<div class="content-section">
	<div class="form-group row">
		<label class="form-label col-md-3">@lang('admin_messages.property') @lang('messages.service_charge') @lang('admin_messages.type')</label>
		<div class="col-md-9">
	...
	<div class="form-group row">
		<label for="service_charge" class="col-sm-3 col-form-label"> @lang('admin_messages.property') @lang('messages.service_charge')</label>
		<div class="col-sm-9">
			<div class="input-group">
				{!! Form::text('service_charge',null,['class'=>'form-control','v-model' => 'hotel.service_charge']) !!}
				<div class="input-group-append">
					<span class="input-group-text" v-if="hotel.service_charge_type == 'fixed'">@{{ hotel.currency_code }}</span>
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<div class="input-group">
				...
				<div class="input-group-append">
					<span class="input-group-text" v-if="hotel.property_tax_type == 'fixed'">@{{ hotel.currency_code }}</span>
...
<div class="content-section">
	<div class="form-group row">
		<label for="status" class="col-sm-3 col-form-label"> @lang('messages.hotel_status')</label>
		<div class="col-sm-9">
	...
	<div class="form-group row">
		<label for="admin_status" class="col-sm-3 col-form-label"> @lang('messages.admin_status') </label>
		<div class="col-sm-9 p-2 px-3">
			<span v-if="hotel.completed_percent == 100">@{{ hotel.admin_status }}</span>
			<span v-else>@lang('admin_messages.not_completed')</span>
		</div>
	</div>
	<div class="form-group row">
		<label for="admin_commission" class="col-sm-3 col-form-label"> @lang('messages.admin_commission') % </label>
		<div class="col-sm-9 p-2 px-3">
			@{{ hotel.admin_commission }}
		</div>
	</div>
</div>
@endsection
@push('scripts')
	...
	$(document).ready(function () {
        $('#remove-photo-btn').click(function() {
            var id = $(this).data('id');
            var url = "{{ route('host.delete_hotel_propety_logo', ['id' => ':id']) }}";
