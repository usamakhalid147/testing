	...
	<div class="page-inner">
		<div class="page-header">
			...
			<ul class="breadcrumbs">
				...
				<li class="nav-item">
					<a href="#">@lang("admin_messages.roles_privilege")</a>
				</li>
			</ul>
		</div>
		<div class="row">
				...
				<div class="card">
					<div class="card-header">
						<div class="d-flex align-items-center">
							...
							@checkHostPermission('create-host_roles')
							<a href="{{ route('host.roles.create') }}" class="btn btn-primary btn-round ms-auto">
								@lang('admin_messages.add_role')
							</a>
