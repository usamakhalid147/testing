...
<div class="content-section">
	<div class="form-group col-md-12" :class="{'required-input': room.name == ''}">
		<label>@lang('messages.room') @lang('admin_messages.category') <em class="text-danger"> *</em></label>
		<input type="text" name="name" id="name" class="form-control" v-model="room.name" placeholder="{{ Lang::get('messages.room').' '.Lang::get('admin_messages.category') }}">
	...
	<div class="form-group col-md-12" :class="{'required-input': room.description == ''}">
		...
		<textarea rows="5" name="description" id="description" class="form-control" v-model="room.description" placeholder="{{ Lang::get('admin_messages.room').' '.Lang::get('admin_messages.description') }}"></textarea>
...
<div class="content-section">
	<div class="form-group row" :class="{'required-input': room.number == ''}">
		<label class="col-md-3 col-form-label">
			@lang('admin_messages.total_no_rooms') <br/> @lang('admin_messages.total_no_category') <em class="text-danger"> *</em></label>
		<div class="col-md-9">
	...
	<div class="form-group row" :class="{'required-input': room.hotel_room_price.price == ''}">
		...
		<div class="col-md-9">
			<div class="input-group">
				...
				<input type="number" name="price" class="form-control" placeholder="{{ Lang::get('admin_messages.price') }}" v-model="room.hotel_room_price.price">
		  		<div class="input-group-append">
...
<div class="content-section">
	<div class="form-group">
		...
		<div class="content-title my-3" v-if="bed_types.length > 0">
			<p class="fw-bold h4"> @lang('admin_messages.extra_beds') </p>
		</div>
