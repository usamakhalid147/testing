	...
	<div class="page-inner">
		<div class="page-header">
			...
			<ul class="breadcrumbs">
				...
				<li class="nav-item">
					<a href="{{ route('host.hotels.edit',['id' => $room->hotel->id]) }}">@lang("admin_messages.hotel") : {{ $room->hotel->name }}</a>
				</li>
				<li class="separator">
					<i class="flaticon-right-arrow"></i>
				</li>
				<li class="nav-item">
					<a href="{{ route('host.rooms',['id' => $room->hotel->id]) }}">@lang("admin_messages.rooms")</a>
				</li>
				<li class="separator">
					<i class="flaticon-right-arrow"></i>
				</li>
...
<script type="text/javascript">
	routeList['update_room'] = {!! json_encode(route('host.rooms.update',['id' => $room->id])); !!};
	routeList["update_room_photo_order"] = {!! json_encode(route("host.rooms.update_room_photo_order")) !!},
