	...
	<div class="page-inner">
		<div class="page-header">
			...
			<ul class="breadcrumbs">
				...
				<li class="nav-item">
					<a href="{{ route('host.hotels.edit',['id' => $hotel->id]) }}">@lang("admin_messages.hotel") : {{$hotel->name}}</a>
				</li>
				<li class="separator">
					<i class="flaticon-right-arrow"></i>
				</li>
				<li class="nav-item">
					<a href="{{ route('host.rooms',['id' => $hotel->id]) }}">@lang("admin_messages.rooms")</a>
				</li>
				<li class="separator">
					<i class="flaticon-right-arrow"></i>
				</li>
		...
		<div class="row">
			<div class="col-md-12">
				{!! Form::open(['url' => route('host.rooms.store'), 'class' => 'form-horizontal','id'=>'hotel_form','method' => "POST", 'files' => true]) !!}
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="form-group">
							<label for="name">@lang('messages.room') @lang('admin_messages.category')<em class="text-danger">*</em>
							</label>
							{!! Form::text('name',old('name',$result->name),['id' => 'name','class'=>'form-control','placeholder' => Lang::get('admin_messages.name')]) !!}
							<p class="text-danger"> {{ $errors->first('name') }} </p>
						</div>
						<div class="form-group">
							<label for="description">@lang('messages.room') @lang('messages.description') <em class="text-danger">*</em></label>
						...
						<div class="form-group">
							<label for="beds">@lang('admin_messages.no_of_beds') <em class="text-danger">*</em>
							</label>
							<input type="number" name="beds" class="form-control" placeholder="{{ Lang::get('admin_messages.no_of_beds') }}" value="{{ old('beds',$result->beds) }}">
							<p class="text-danger"> {{ $errors->first('beds') }} </p>
						</div>
					</div>
					<div class="card-action">
						<a href="{{ route('host.rooms',['id' => $hotel->id])}}" class="btn btn-danger"> @lang('admin_messages.back') </a>
