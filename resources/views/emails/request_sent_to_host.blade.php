		...
		<td style="padding: 16px;">
			<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td style="padding: 16px;">
							<a href="{{ $reservation_data['inbox_link'] }}" target="_blank" class="theme_back" style="width: 100%;background-color: #008276;border: solid 1px #008276;border-radius: 5px;box-sizing: border-box;color: white;display: inline-block;font-weight: bold;padding: 12px 25px;text-decoration: none;text-align: center;"> @lang('messages.message_to_host') </a>
						</td>
					</tr>
					<tr>
