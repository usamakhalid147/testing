				...
				<tbody>
					<tr>
						<td style="padding:16px;">
							<p> @lang('messages.hi_user',['replace_key_1' => $host_data['user_name']]),</p>
							<p>
								@lang('messages.leave_review_for',['replace_key_1' => $user_data['user_name']]).@lang('messages.you_each_have_days_to_complete_review',['replace_key_1' => MAX_REVIEW_DAYS]).
