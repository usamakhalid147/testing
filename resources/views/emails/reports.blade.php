		...
		<tbody>
			...
			<tr>
				<td colspan="2" style="padding: 60px 0 20px;">
					<p class="mb-0 tl-lg-pdf text-center">@lang('admin_messages.guest_details')</p>
				</td>
			</tr>
			<tr>
				<td colspan="">
					<table style="width: 100%;" class="patient-details">
						<tbody>
							<tr>
								<td class="w-30 ">
									<p class="m-0 para-pdf">@lang('admin_messages.name')</p>
								</td>
								<td class="w-70 ">
							...
							<tr>
								<td class="w-30 ">
									<p class="m-0 para-pdf">@lang('admin_messages.phone_number')</p>
								</td>
								<td class="w-70 ">
									<p class="m-0 para-pdf">
										{{ $user->phone_number }}
							...
							<tr>
								<td class="w-30 ">
									<p class="m-0 para-pdf">@lang('admin_messages.email')</p>
								</td>
								<td class="w-70 ">
									<p class="m-0 para-pdf">
										{{ $user->email }}
							...
							<tr>
								<td class="w-30 ">
									<p class="m-0 para-pdf">@lang('admin_messages.hotel_name')</p>
								</td>
								<td class="w-70 ">
									<p class="m-0 para-pdf">
										{{ $result->hotel->name }}
							...
							<tr>
								<td class="w-30 ">
									<p class="m-0 para-pdf">@lang('admin_messages.hotel_address')</p>
								</td>
								<td class="w-70 ">
									<p class="m-0 para-pdf">
							...
							<tr>
								<td class="w-30 ">
									<p class="m-0 para-pdf">@lang('admin_messages.booking_dates')</p>
								</td>
								<td class="w-70 ">
									<p class="m-0 para-pdf">
							...
							<tr>
								<td class="w-30 ">
									<p class="m-0 para-pdf">@lang('admin_messages.number_of_adults')</p>
								</td>
								<td class="w-70 ">
									<p class="m-0 para-pdf">
							...
							<tr>
								<td class="w-30 ">
									<p class="m-0 para-pdf">@lang('admin_messages.number_of_children')</p>
								</td>
								<td class="w-70 ">
									<p class="m-0 para-pdf">
							...
							<tr>
								<td class="w-30 ">
									<p class="m-0 para-pdf">@lang('messages.cancellation_policy')</p>
								</td>
								<td class="w-70 ">
									<p class="m-0 para-pdf">
							...
							<tr>
								<td class="w-30 ">
									<p class="m-0 para-pdf">@lang('admin_messages.status')</p>
								</td>
								<td class="w-70 ">
									<p class="m-0 para-pdf">
										{{ $result->status }}
				...
				<td colspan="">
					<table style="width: 100%;" class="patient-details">
						<tbody>
							<tr>
								<td class="w-30 ">
									<p class="m-0 para-pdf">@lang('admin_messages.service_fee')</p>
								</td>
								<td class="w-70 ">
									<p class="m-0 para-pdf">
										<span>
							...
							<tr>
								<td class="w-30 ">
									<p class="m-0 para-pdf">@lang('admin_messages.host_fee')</p>
								</td>
								<td class="w-70 ">
									<p class="m-0 para-pdf">
										<span>
							...
							<tr>
								<td class="w-30 ">
									<p class="m-0 para-pdf">@lang('admin_messages.total')</p>
								</td>
								<td class="w-70 ">
									<p class="m-0 para-pdf">
										<span>
