		...
		<td style="padding: 16px;">
			<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
											...
											<table>
												<tr>
													<td width="100%" style="padding: 16px;">
														...
														<p style="color: #7c7c7c;"> {{ $hotel_data['address_line'] }} </p>
														<a href="http://maps.google.com/maps?daddr={{ $hotel_data['latitude'] }},{{ $hotel_data['longitude'] }}" style="color: #ec8d37;text-decoration: none;"> @lang('messages.get_directions') </a>
													</td>
												</tr>
											</table>
										</td>
					...
					<tr>
						<td style="padding: 16px;">
							<a href="{{ $reservation_data['itinerary_link'] }}" target="_blank" class="theme_back" style="width: 100%;background-color: #ec8d37;border: solid 1px #ec8d37;border-radius: 5px;box-sizing: border-box;color: white;display: inline-block;font-weight: bold;padding: 12px 25px;text-decoration: none;text-align: center;"> @lang('messages.view_full_itinerary') </a>
						</td>
					</tr>
					<tr>
