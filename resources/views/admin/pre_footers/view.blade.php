	...
	<div class="page-inner">
		<div class="page-header">
			...
			<ul class="breadcrumbs">
				...
				<li class="nav-item">
					<a href="#">@lang("admin_messages.pre_footers")</a>
				</li>
			</ul>
		</div>
		<div class="row">
				...
				<div class="card">
					<div class="card-header">
						<div class="d-flex align-items-center">
							<h4 class="card-title">
								@lang("admin_messages.pre_footers")
							</h4>
							@checkPermission('create-pre_footers')
							<a href="{{ route('admin.pre_footers.create') }}" class="btn btn-primary btn-round ms-auto">
								@lang('admin_messages.add_pre_footer')
							</a>
							@endcheckPermission
						</div>
					</div>
