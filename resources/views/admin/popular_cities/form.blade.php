<div class="card">
	...
	<div class="card-body">
		...
		<div class="form-group">
			...
			{!! Form::hidden('viewport',null,['id' => 'viewport']) !!}
		...
		<div class="form-group">
			...
			{!! Form::select('country_code',$country_list,$result->country_code ?? '',['class'=>'form-select','placeholder' => Lang::get('messages.select')]) !!}
	...
	<div class="card-action">
		<a href="{{ route('admin.popular_cities')}}" class="btn btn-danger"> @lang('admin_messages.back') </a>
