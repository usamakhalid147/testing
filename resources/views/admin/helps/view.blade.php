	...
	<div class="page-inner">
		<div class="page-header">
			...
			<ul class="breadcrumbs">
				...
				<li class="nav-item">
					<a href="#">@lang("admin_messages.helps")</a>
				</li>
			</ul>
		</div>
		<div class="row">
				...
				<div class="card">
					<div class="card-header">
						<div class="d-flex align-items-center">
							<h4 class="card-title"> @lang("admin_messages.helps") </h4>
							@checkPermission('create-helps')
							<a href="{{ route('admin.helps.create') }}" class="btn btn-primary btn-round ms-auto">
								@lang('admin_messages.add_help')
							</a>
							@endcheckPermission
						</div>
					</div>
