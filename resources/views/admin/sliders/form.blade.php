<div class="card">
	...
	<div class="card-body">
		...
		<div class="form-group">
			...
			{!! Form::text('description', $result->description, ['class' => 'form-control', 'id' => 'description']) !!}
		...
		<div class="form-group input-file input-file-image">
			...
			<span class="text-danger">Image must be in portrait form & with minimum dimensions as (600x400)</span>
		</div>
		<div class="form-group">
	...
	<div class="card-action">
		<a href="{{ route('admin.sliders')}}" class="btn btn-danger"> @lang('admin_messages.back') </a>
