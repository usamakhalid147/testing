	...
	<div class="page-inner">
		<div class="page-header">
			...
			<ul class="breadcrumbs">
				...
				<li class="nav-item">
					<a href="#">@lang("admin_messages.home_page_sliders")</a>
				</li>
			</ul>
		</div>
		<div class="row">
				...
				<div class="card">
					<div class="card-header">
						<div class="d-flex align-items-center">
							...
							@checkPermission('create-sliders')
							<a href="{{ route('admin.sliders.create') }}" class="btn btn-primary btn-round ms-auto">
								@lang('admin_messages.add_home_page_sliders')
							</a>
							@endcheckPermission
						</div>
					</div>
