	...
	<div class="page-inner">
		<div class="page-header">
			...
			<ul class="breadcrumbs">
				...
				<li class="nav-item">
					<a href="{{ route('admin.penalties') }}">@lang("admin_messages.penalties")</a>
				</li>
				<li class="separator">
					<i class="flaticon-right-arrow"></i>
				</li>
			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body form-horizontal">
						...
						<div class="row align-items-baseline">
							<label class="col-sm-4 col-form-label form-label">  @lang('admin_messages.reservation') <a href="{{ route('admin.reservations.show',['id' => $reservation->id]) }}"> # {{ $reservation->id }}</a> </label>
							<div class="col-sm-8">
								<div class="form-group">
					...
					<div class="card-action d-flex">
						<a href="{{ route('admin.penalties')}}" class="btn btn-info"> @lang('admin_messages.back') </a>
					</div>
				</div>
			</div>
		</div>
