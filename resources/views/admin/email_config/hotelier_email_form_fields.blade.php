<div class="card-body">
        <input type="text" hidden name="site_value" value="HotelierEmailConfig">
        <div class="form-group">
			<label for="driver"> @lang('admin_messages.driver') <em class="text-danger">*</em> </label>
			{!! Form::select('driver', MAIL_DRIVERS, old('driver',credentials('driver','HotelierEmailConfig')), ['class' => 'form-select', 'id' => 'driver']) !!}
			<span class="text-danger">{{ $errors->first('driver') }}</span>
		</div>
		<div class="form-group">
			<label for="host"> @lang('admin_messages.host') <em class="text-danger">*</em> </label>
			{!! Form::text('host', old('host',credentials('host','HotelierEmailConfig')), ['class' => 'form-control', 'id' => 'host']) !!}
			<span class="text-danger">{{ $errors->first('host') }}</span>
		</div>
		<div class="form-group">
			<label for="port"> @lang('admin_messages.port') <em class="text-danger">*</em> </label>
			{!! Form::text('port', old('port',credentials('port','HotelierEmailConfig')), ['class' => 'form-control', 'id' => 'port']) !!}
		...
		<div class="form-group">
			...
			{!! Form::text('encryption', old('encryption',credentials('encryption','HotelierEmailConfig')), ['class' => 'form-control', 'id' => 'encryption']) !!}
		...
		<div class="form-group">
			...
			{!! Form::text('from_name', old('from_name',credentials('from_name','HotelierEmailConfig')), ['class' => 'form-control', 'id' => 'from_name']) !!}
		...
		<div class="form-group">
			...
			{!! Form::text('from_address', old('from_address',credentials('from_address','HotelierEmailConfig')), ['class' => 'form-control', 'id' => 'from_address']) !!}
		...
		<div class="form-group">
			...
			{!! Form::text('username', old('username',credentials('username','HotelierEmailConfig')), ['class' => 'form-control', 'id' => 'username']) !!}
			<span class="text-danger">{{ $errors->first('username') }}</span>
		</div>
		<div class="form-group">
			<label for="app_password"> @lang('admin_messages.password') <em class="text-danger">*</em> </label>
			{!! Form::text('app_password', old('app_password',credentials('password','HotelierEmailConfig')), ['class' => 'form-control', 'id' => 'app_password']) !!}
