<div class="card">
	...
	<div class="card-body">
		...
		<div class="form-group input-file input-file-image">
			<img class="img-upload-preview" src="{{ $result->image_src ?? asset('images/preview_thumbnail.png') }}" ng-hide="type == 'Video'">
		...
		<div class="form-group">
			...
			{!! Form::select('status', array('1' => 'Active', '0' => 'Inactive'), old('status',$result->status), ['class' => 'form-control', 'id' => 'status', 'placeholder' => Lang::get("admin_messages.select")]) !!}
