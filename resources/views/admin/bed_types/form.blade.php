<div class="card">
	...
	<div class="card-body">
		...
		<div class="form-group">
			<label for="is_show_extra_price"> @lang('admin_messages.is_show_extra_price') <em class="text-danger">*</em> </label>
			{!! Form::select('is_show_extra_price', $yes_no_array, old('is_show_extra_price',$result->is_show_extra_price), ['class' => 'form-select', 'id' => 'is_show_extra_price', 'placeholder' => Lang::get("admin_messages.select")]) !!}
			<span class="text-danger">{{ $errors->first('is_show_extra_price') }}</span>
		</div>		
		<div class="form-group">
