...
return [
    ...
    |--------------------------------------------------------------------------
    */
    'googleApplicationName' => env('TS_GOOGLE_APP_NAME', 'HyraHotel'),
    ...
    */
    'serviceAccountEmail' => env('TS_SERVICE_ACCOUNT_EMAIL', 'translation-sheet@staysnap.iam.gserviceaccount.com'),
    ...
    */
    'spreadsheetId' => env('TS_SPREADSHEET_ID', '1xbuYRxEyBaIHdOmcA2MWAdg68AtdWcVf7cR4HPGji6c'),
    ...
    */
    'locales' => env('TS_LOCALES', ['en','ar', 'ca', 'da', 'de', 'es', 'el', 'fa', 'fi', 'fr', 'hi', 'hu', 'id', 'it', 'ja', 'ko', 'ms', 'nl', 'pl', 'pt', 'ru', 'ta', 'th', 'tr', 'zh']),
