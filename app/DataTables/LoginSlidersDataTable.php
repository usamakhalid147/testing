...
/**
 * Login Sliders Datatable
 *
 * @package     HyraHotel
 * @subpackage  DataTables
 * @category    LoginSlidersDataTable
...
class LoginSlidersDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('action',function($query) {
            $edit = getCurrentUser()->can('update-login_sliders') ? '<a href="'.route('admin.login_sliders.edit',['id' => $query->id]).'" class="h3"> <i class="fa fa-edit"></i> </a>' : '';
            $delete = getCurrentUser()->can('delete-login_sliders') ? '<a href="" data-action="'.route('admin.login_sliders.delete',['id' => $query->id]).'" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal" class="h3"> <i class="fa fa-trash-alt"></i> </a>' : '';
            return $edit." &nbsp; ".$delete;
        })
