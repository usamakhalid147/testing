...
class RoleController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->view_data['user_type'] = $this->user_type = 'admin';
        $this->view_data['sub_title'] = Lang::get('admin_messages.admin_roles');
    }
    ...
    public function destroy($id)
    {
        ...
        try {
            $role = Role::where('user_type',$this->user_type)->find($id);
            $role->users()->sync([]);
