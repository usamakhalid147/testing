...
/**
 * Hotel Amenity Controller
 *
 * @package     HyraHotel
 * @subpackage  Controllers\Admin
 * @category    HotelAmenityController
...
class HotelAmenityController extends Controller
{
	...
	*/
	public function __construct()
	{
		...
		$this->view_data['main_title'] = Lang::get('admin_messages.manage_hotel_amenities');
		$this->view_data['active_menu'] = 'hotel_amenities';
		$this->view_data['sub_title'] = Lang::get('admin_messages.hotel_amenities');
		$this->base_path = 'admin.hotel_amenities';
		$this->list_type = 'hotel';
	}
	...
	*/
	...
	{
		$this->view_data['sub_title'] = Lang::get('admin_messages.add_hotel_amenity');
	...
	*/
	...
	{
		$this->view_data['sub_title'] = Lang::get('admin_messages.edit_hotel_amenity');
